public function testId(): void {
  ...
  $this->assertFalse(array_key_exists("id", $props), "El id debe ser público");
}
...
public function testTitulo(): void {
  ...
  $this->assertFalse(array_key_exists("titulo", $props), "El titulo debe ser público");
}
...
public function testRating(): void {
  ...
  $this->assertFalse(array_key_exists("rating", $props), "El rating debe ser público");
}
...
public function testFecha(): void {
  ...
  $this->assertFalse(array_key_exists("fechaDeEstreno", $props), "La fechaDeEstreno debe ser pública");
}
